      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-gray-50 dark:bg-[hsl(220,18%,10%)] rounded-3xl p-10 md:p-16 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="#contact" className="bg-brand text-white hover:bg-[#e64627] transition-colors rounded-full px-8 py-4 font-medium text-lg hover:scale-[1.03] transition-transform btn-optical-lg">
              Обсудить задачу
            </a>
            <a href="#contact" className="bg-white dark:bg-[hsl(220,20%,7%)] text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-[hsl(220,18%,14%)] transition-colors rounded-full px-8 py-4 font-medium text-lg btn-optical-lg">
              Узнать бюджет
            </a>
          </div>
        </div>
