    ...
    >
      <div className="flex flex-row items-center justify-between px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#contact" className={`rounded-full px-6 py-2.5 text-sm font-medium transition-all duration-300 hover:scale-[1.03] inline-flex items-center justify-center btn-optical-xs ${
            scrolled
