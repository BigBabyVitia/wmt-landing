...
export function ProgramBlock({ num, time, title, text }: ProgramBlockProps) {
  return (
    <div className="flex flex-col md:flex-row border-b border-gray-200 dark:border-white/10 pb-12 gap-8">
      ...
      <div className="md:w-3/4">
        ...
        <p className="text-gray-700 dark:text-gray-200 leading-relaxed text-lg">{text}</p>
      </div>
    </div>
  )
}
