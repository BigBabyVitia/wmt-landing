    ...
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black flex flex-col pt-20 pb-32 sm:pt-24 sm:pb-40">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 mt-4 sm:mt-12">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[72px] leading-[1.05] tracking-tight max-w-[1000px] font-semibold text-white animate-fade-rise">
          <em className="not-italic text-brand font-bold">ИИ-трансформация</em> бизнеса.<br /> От стратегии до результата
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 animate-fade-rise-delay-2">
          <a href="#contact" className="liquid-glass rounded-full px-12 py-4 text-base font-medium text-white hover:scale-[1.03] transition-transform cursor-pointer inline-block btn-optical-lg">
            Обсудить задачу
          </a>
          <a href="#formats" className="liquid-glass rounded-full px-12 py-4 text-base font-medium text-white hover:scale-[1.03] transition-transform cursor-pointer inline-block btn-optical-lg">
            Смотреть форматы
          </a>
        </div>
      </div>
