    ...
    <section ref={ref} className="py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-white dark:bg-[hsl(220,20%,7%)]">
      <div className="max-w-7xl mx-auto">
        <div className={`flex flex-col sm:flex-row gap-8 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div>
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-2">Игорь Никитин</h2>
            <p className="text-brand font-medium mb-6">Основатель WMT AI, 400+ сотрудников</p>
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="text-sm text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-[hsl(220,18%,14%)] px-4 py-2 rounded-lg font-medium">50+ проектов 2024–2026</span>
              <span className="text-sm text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-[hsl(220,18%,14%)] px-4 py-2 rounded-lg font-medium">Патент в области ИИ</span>
              <span className="text-sm text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-[hsl(220,18%,14%)] px-4 py-2 rounded-lg font-medium">Исследование с Ipsos</span>
            </div>
    ...
    <section ref={ref} className="py-16 px-6 md:px-12 bg-gray-50 dark:bg-[hsl(220,18%,10%)] border-t border-gray-100 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        <div className={`transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-4">Клиенты</h2>
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 text-sm mb-8">Стратегические сессии для CEO и C-level, архитектура ИИ-процессов, воркшопы и консалтинг по ИИ-трансформации.</p>
    ...
    <section ref={ref} className="py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-white dark:bg-[hsl(220,20%,7%)] border-t border-gray-100 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        <div className={`max-w-3xl transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-6">Методология WMT&nbsp;AI получила признание Stanford Global Studies</h2>
          <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500 leading-relaxed mb-4">
          ...
          <div className="bg-gray-50 dark:bg-[hsl(220,18%,10%)] rounded-xl p-6 border border-gray-100 dark:border-white/[0.06] mb-6 transition-all duration-300 hover:border-gray-200 dark:hover:border-white/10 hover:shadow-sm">
    ...
    <section ref={ref} className="py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-gray-50 dark:bg-[hsl(220,18%,10%)] border-t border-gray-100 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        <div className={`transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-8">Ниже&nbsp;&mdash; публичные материалы, которые вы можете открыть и изучить до разговора о программе.</p>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">20+ публикаций в деловых СМИ</h3>
          <div className="flex flex-wrap gap-3 mb-4">
            {publications.map((p, i) => (
              <span key={i} className="text-sm text-gray-700 dark:text-gray-200 bg-white dark:bg-[hsl(220,20%,7%)] px-5 py-3 rounded-xl border border-gray-100 dark:border-white/[0.06] font-medium transition-all duration-300 hover:border-gray-200 dark:hover:border-white/10 hover:shadow-sm">{p}</span>
            ))}
          </div>
          <p className="text-gray-400 dark:text-gray-500 text-sm">Тема публикаций&nbsp;&mdash; ИИ-трансформация бизнеса, организационные модели, стратегия ИИвизации.</p>
        </div>
      </div>
    </section>
  )
        ...
        <div className={`max-w-3xl transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="space-y-3">
            {podcastGuests.map((g, i) => (
              <div key={i} className="flex items-start gap-3 text-gray-700 dark:text-gray-200 bg-gray-50 dark:bg-[hsl(220,18%,10%)] rounded-xl px-5 py-3 border border-gray-100 dark:border-white/[0.06] transition-all duration-300 hover:border-gray-200 dark:hover:border-white/10 hover:shadow-sm">
    ...
    <section ref={ref} className="py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-white dark:bg-[hsl(220,20%,7%)] border-t border-gray-100 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        <div className={`transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-12">Игорь Никитин и&nbsp;команда WMT&nbsp;AI регулярно выступают на&nbsp;площадках, которые можно проверить.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">2025</h3>
              <div className="space-y-2">
                {events2025.map((e, i) => (
                  <div key={i} className="text-gray-600 dark:text-gray-400 dark:text-gray-500 text-sm pl-4 border-l-2 border-brand py-1">{e}</div>
                ))}
              </div>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">2026</h3>
              <div className="space-y-2">
                {events2026.map((e, i) => (
                  <div key={i} className="text-gray-600 dark:text-gray-400 dark:text-gray-500 text-sm pl-4 border-l-2 border-gray-300 dark:border-white/20 py-1">{e}</div>
                ))}
              </div>
            </div>
          </div>
    ...
    <section className="py-16 md:py-24 px-4 sm:px-6 md:px-12 bg-gray-50 dark:bg-[hsl(220,18%,10%)] border-t border-gray-100 dark:border-white/[0.06]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {navCards.map((c, idx) => (
            <Link key={idx} to={c.to} className="bg-white dark:bg-[hsl(220,20%,7%)] rounded-xl p-5 border border-gray-100 dark:border-white/[0.06] transition-all duration-500 hover:border-gray-300 dark:hover:border-white/20 hover:shadow-lg hover:shadow-gray-200/50 hover:-translate-y-1 group">
              <span className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-brand transition-colors flex items-center gap-2">
                {c.label} <ArrowRight className="w-4 h-4" />
              </span>
            </Link>
          ))}
        </div>
        <p className="text-gray-400 dark:text-gray-500 text-sm mt-8">Если вы уже участник программы и вам нужен доступ&nbsp;&mdash; <Link to="#" className="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-400 dark:text-gray-500 underline">войдите в личный кабинет</Link>.</p>
      </div>
    </section>
  )
}
