        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border border-gray-100 rounded-2xl bg-white ">
              ...
              <CardContent><p className="text-gray-600">Осваивает промптинг, агентов и контент. Работает с ИИ не из-под палки, а из-за кратного роста скорости своей работы.</p></CardContent>
            </Card>
            <Card className="border border-gray-100 rounded-2xl bg-white ">
              <CardHeader><CardTitle className="text-xl text-brand">Уровень: Руководитель</CardTitle></CardHeader>
              <CardContent><p className="text-gray-600">Видит прозрачные борды: прогресс, доходимость, рейтинги. Знает внутренних амбассадоров ИИ поименно.</p></CardContent>
            </Card>
            <Card className="border border-gray-100 rounded-2xl bg-white ">
              <CardHeader><CardTitle className="text-xl text-brand">Уровень: Компания</CardTitle></CardHeader>
              <CardContent><p className="text-gray-600">Растет корпоративная база знаний: лучшие промпты и агенты пополняют копилку. Бизнес говорит на едином цифровом языке.</p></CardContent>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section id="budget" className="py-24 px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto flex gap-12 flex-col lg:flex-row items-center">
            <div className="lg:w-2/3">
                ...
                <p className="text-xl text-gray-600 mb-8">Запуск на 50+ человек. Масштабируется до 500+.</p>
