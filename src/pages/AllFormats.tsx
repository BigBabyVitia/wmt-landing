...
const execPrograms = [
  { name: "Мышление 2.0", audience: "Компания, которой нужна команда-чемпион, ядро практиков", result: "до 20 человек, которые работают с ИИ и тянут остальных", format: "1 день / 8 ч, 80% работы руками, Офлайн / Онлайн", next: "Масштабирование на компанию", proof: "Рабочий агент у каждого участника", },
  ...
  { name: "Цифровой каркас", audience: "Компания, которой нужен защищаемый первый пилот", result: "1–2 пилота, архитектура перехода, владельцы процесса", format: "Корпоративный практикум, 1–2 дня", next: "От пилота к команде-чемпиону", proof: "60% практики руками, live-демо агентов", },
  ...
  { name: "ИИ-практикум для руководителей", audience: "Управленческая команда, которая уже понимает тему, но не перешла в практику", result: "Практическая работы с ИИ на ваших задачах и план следующего шага", format: "Месячная программа (6 занятий)", next: "Масштабирование на компанию", },
]
