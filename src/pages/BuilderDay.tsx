...
const fitItems = [
  { text: "Есть собранная команда до 15 человек", fit: true },
...
const preparation = [
  ...
  { title: "Понятный состав", desc: "Кто участвует и зачем именно эти люди должны пройти день вместе. Оптимально до 15 человек." },
...
const nextSteps = [
  ...
  { title: "Глубокая сборка агентов", program: "Мастерская ИИ-агентов", desc: "Когда сильнейшие участники хотят пойти дальше в RAG, multi-agent, error handling в n8n.", to: "/teams" },
]
  ...
  return (
    <div className="bg-white dark:bg-black text-gray-900 dark:text-white min-h-screen transition-colors duration-300">
      <V2Hero 
        ...
        description={
          <>
            Практический интенсив для собранной команды с конкретной задачей. 6 часов работы, свой агент и алгоритм повторной сборки на выходе.
            <span className="block mt-4 text-gray-600 dark:text-white/50 text-base max-w-3xl leading-relaxed">
              Формат рассчитан на группу до 15 человек. Каждый участник проходит через 5 блоков сборки: от выбора мозга модели до финального интерфейса.
            </span>
          </>
        }
        buttons={
