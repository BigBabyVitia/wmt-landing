...
const programs = [
  {
    ...
    result: "Руководство получает ясное понимание, где ИИ может дать компании реальный эффект, а компания — первый осмысленный шаг в ИИ-трансформации вместо абстрактного интереса",
    resultBullets: ["Руководство получает ясное понимание, где ИИ даст компании реальный эффект", "Компания получает первый осмысленный шаг в ИИ-трансформации", "Устраняется ситуация абстрактного интереса к технологиям"],
    results: [
  ...
  },
  {
    ...
    result: "Компания получает архитектуру ИИ-перехода, приоритизированные направления и 1–2 пилота, готовых к запуску, а руководство — ясность, как двигаться дальше без хаоса и распыления.",
    resultBullets: ["Компания получает архитектуру ИИ-перехода и приоритетные направления", "Подготовлены 1–2 пилота, готовых к запуску", "У руководства появляется ясность, как двигаться без хаоса и распыления"],
    results: [
  ...
  },
  {
    ...
    result: "Руководители получают рабочее понимание ИИ через практику на собственных задачах, а компания — топ-команду, которая уверенно задаёт следующий шаг ИИ-трансформации и готова масштабировать его дальше.",
  ...
  },
  {
    ...
    result: "Руководитель получает персонально собранную работу с ИИ под свои цели, уровень и контекст, а компания — сильного внутреннего драйвера, который понимает, как двигать ИИ-трансформацию дальше.",
    resultBullets: ["Руководитель получает персонально собранную работу с ИИ под свои цели", "Учитывается личный уровень и глубокий рабочий контекст", "Компания получает сильного внутреннего драйвера ИИ-трансформации"],
    results: [
  ...
  return (
    <>
      <V2Hero 
        ...
        title={<>WMT AI помогает собрать архитектуру <em className="not-italic text-brand font-bold">ИИ-трансформации</em> компании</>}
        ...
        <div className={`transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-20 items-start">
            ...
            <div className="lg:col-span-7">
              ...
              {p.diff && (
                <div className="relative overflow-hidden bg-gradient-to-br from-brand/[0.08] to-transparent dark:from-brand/[0.12] border border-brand/20 p-6 md:p-8 rounded-[1.25rem] mb-8 max-w-2xl shadow-sm">
            ...
            <div className="lg:col-span-span-5 lg:pt-[42px] mt-8 lg:mt-0">
              <div className="bg-white dark:bg-white/[0.03] backdrop-blur-sm border border-gray-100 dark:border-white/[0.06] rounded-[1.5rem] p-6 md:p-10 shadow-sm relative overflow-hidden group hover:border-brand/20 transition-all duration-500">
        ...
        <div className={`transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          ...
          <div className="relative isolate px-2 md:px-6">
            ...
            <div className="flex gap-6 md:gap-10 items-start mb-10">
              ...
              <div className="flex-1 bg-white dark:bg-white/[0.03] border border-gray-100 dark:border-white/[0.06] p-6 md:p-8 rounded-[1.25rem] shadow-sm transform-gpu hover:-translate-y-1 transition-all duration-300">
            ...
            <div className="flex gap-6 md:gap-10 items-start mb-10 relative">
              ...
              <div className="flex-1 bg-gradient-to-br from-brand to-[#cc3a1f] p-6 md:p-8 rounded-[1.25rem] shadow-xl shadow-brand/10 text-white">
            ...
            <div className="flex gap-6 md:gap-10 items-start">
              ...
              <div className="flex-1 bg-gray-900 dark:bg-black border border-gray-800 dark:border-white/[0.08] p-6 md:p-8 rounded-[1.25rem] shadow-xl text-white">
